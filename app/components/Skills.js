...
export function SkillSection() {
  const technologies = [
    ...
    { src: "/tailwind.svg", alt: "Tailwind CSS", delay: 0.05 },
    {
      ...
      alt: "MongoDB",
      delay: 0.1,
      className: "relative top-[2px] sm:top-1",
    },
    {
      src: "/express.svg",
      alt: "Express.js",
    ...
    { src: "/graphql.svg", alt: "GraphQL", delay: 0.4 },
    { src: "/redux.svg", alt: "Redux", delay: 0.45 },
    {
      src: "/typescript.svg",
      alt: "TypeScript",
      delay: 0.5,
      className: "scale-75 rounded-md sm:rounded-lg",
    },
    {
      src: "/aws.svg",
      alt: "AWS",
    ...
    { src: "/socketio.svg", alt: "Socket.IO", delay: 0.7 },
    { src: "/java.svg", alt: "Java", delay: 0.75 },
    { src: "/git.svg", alt: "Git", delay: 0.8 },
  ];
